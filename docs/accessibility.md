...
| F3 flip cards | Content on the back of a card that assistive technology cannot reach, or a hover-only flip | Native `<details>`. Both faces in the DOM at all times. Click, Enter and Space all work. Never hover-only |
