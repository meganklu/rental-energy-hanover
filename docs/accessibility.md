...
| Page transitions (added and removed 2026-08-26) | A full-page wipe on every navigation is exactly the kind of movement `prefers-reduced-motion` exists for, and it also froze the outgoing page for the whole of the load | Removed. There is no page transition. See [DESIGN.md](../DESIGN.md) §7 |
